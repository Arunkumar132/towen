    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <section className="relative bg-[#7a02cb] text-white overflow-hidden flex items-center justify-center pb-24 sm:pb-32" style={{minHeight:'calc(100vh - 4rem)', marginTop:'4rem'}}>
        ...
        <img
          ...
          alt=""
          aria-hidden="true"
          className="pointer-events-none select-none absolute top-[5px] left-[-100px] sm:left-[-180px] top-4 w-[200px] sm:w-[360px] md:w-[420px] lg:w-[520px] object-contain drop-shadow-xl lg:left-[-192px]"
